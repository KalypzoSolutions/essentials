...
tasks {
    ...
    runServer {
        ...
        downloadPlugins {
            ...
            // url("https://github.com/wandoriamc/economy-provider/releases/download/v1.3.2/EconomyProviderPlugin-1.3.2-all.jar")  // economy provider 3.0.1 deprecated. TODO replace with pgEconomy 2.2.0
