 ...
 * @param content der Inhalt der Nachricht als serialisierter MiniMessage String
 */
public record ChatMessage(@Nullable List<UUID> recipients, @NotNull String content) {
    ...
    public ChatMessage recipients(List<UUID> recipients) {
        return new ChatMessage(recipients, content);
    }
